...
%% CONNECTIONS
    ...
    % BuildingEd -> TileZed
    \draw[dashed_arrow] (buildinged_b41) -- node[above, font=\ttfamily\small] {\textit{merged}} (tilezed_b41);
    ...
    % Alree's tools -> Community Edition tools
    \draw[dashed_arrow] (alree_box) -- node[above, font=\ttfamily\small] {\textit{merge parts}} (community_box);

    % B42 tools -> Alree's tools
    \draw[dashed_arrow] (b42_box) -- node[left, font=\ttfamily\small] {\textit{April 2025 Build}} (alree_box);
